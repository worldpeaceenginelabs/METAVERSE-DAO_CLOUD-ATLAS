...
export default
  ...
  { key: `12`,
    ...
    content: 'The basic principles of TEACHER: -Child interacts with AI according to child\'s interest - discussed topics are stored in personal curriculum - Learning speed is up to the child - General Curriculum is compared with the child\'s personal curriculum, if topics are missing, they are suggested to the child more often to keep up with the general curriculum - In most countries, homeschooling is allowed under certain conditions, generally speaking, if the teacher is qualified. What could be more obvious than a digital teacher that can be programmed to meet these qualifications? And why not complete 13 school years in just 5 years and then study some quantum physics for fun or become a 14-year-old doctor? After all, lessons are now fun, and the teacher answers all questions without exception, and even brainstorms the kid\'s/student\'s ideas with them. ADVANTAGES: The curriculum is accessible online to parents and the public, commentable, and democratized (survey, petition, crowdfunding). Child-friendliness is now verifiable. Social circles are not compulsively mixed, which can lead to problems and bullying (rich vs. poor children, national vs. foreign, strong vs. weak, loud vs. quiet, extrovert vs. introvert, etc.). Such social mixing is essential for the natural development of adolescents, but it should be voluntary, with the possibility to leave the scene, which today\'s school does not provide. And most importantly, their own social circle is strengthened. Kids don\'t have to go to school anymore, so they spend much more time with their family and friends. What a rich and beautiful experience for the maturing soul. 🥰 ULTIMATE FEATURE FOR THE KIDS: The teacher\'s look can be designed with Unreal\'s META-HUMAN by the kids themselves. It\'s their first contact with information technology and AI, which they will develop from day one.',
    href: 'https://www.unrealengine.com/metahuman',
    target: '_blank',
