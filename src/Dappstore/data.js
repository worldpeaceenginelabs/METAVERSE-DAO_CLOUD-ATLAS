...
export default
  [
    ...
    content: 'Are you a creative, developer, maker, activist, or non-profit/for-profit entrepreneur? Bring the real world into Unreal Engine 5 and then back into reality, whether it\'s through browser, mobile, desktop, VR or WebVR -apps, -games. Don\'t know how to code? No problem! You can code whole games and application without knowing to code at all. Have you already created a DApp? Submit it on Github MC|CA /issues/ and use the green label "DAPP STORE" so that I can add it to our DApp store or make it part of our upcoming basic DApps (for now, manually).',
